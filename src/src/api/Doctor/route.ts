...
// export async function createDoctor(formData: { firstName: string; lastName: string; email: string; password: string; phoneNo: string;
//    dateOfBirth: string; gender: string; bio: string; qualification: string; experience: string; paymentPerSession: string; consultationDuration: string; 
//    specializationId: string; role: string; }, formData: DoctorFormData) {
