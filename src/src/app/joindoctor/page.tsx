...
const DoctorRegistrationForm = () => {
  ...
  const [selectedSpecialization, setSelectedSpecialization] = useState<Option | null>(null);
...
console.log(selectedSpecialization)
    ...
    try {
      ...
      if (response.success) {
        setNotification({
          ...
          message:
            'Your registration has been submitted successfully. We will review your application and get back to you soon.',
        });
      } else {
        setNotification({
          isOpen: true,
  ...
  value={
    specializationOptions.find(
      (option: Option) => option.value.toString() === formData.specializationId
    ) || null
  }
